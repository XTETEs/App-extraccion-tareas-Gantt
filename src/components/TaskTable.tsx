...
function TaskTableRow({ task, dateRange }: TaskTableRowProps) {
...
interface TaskTableProjectProps {
    projectName: string;
    projectTasks: Task[];
...
function TaskTableProject({ projectName, projectTasks, projectStore, isCollapsed, toggleProject, dateRange }: TaskTableProjectProps) {
                    ...
                    <table className="w-full text-sm text-left">
                        ...
                        <tbody className="divide-y divide-border/40 bg-card/20">
                            {projectTasks.map((task, idx) => (
                                <TaskTableRow key={task.id + idx} task={task} dateRange={dateRange} />
                            ))}
                        </tbody>
