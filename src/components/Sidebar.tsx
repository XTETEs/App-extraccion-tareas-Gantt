...
function DateFilterCard() {
    const { dateRange, setDateRange, setReportGenerated } = useStore();
    return (
...
function ProjectList({ projects, selectedProjectId, onSelectProject, setIsManagerOpen }: ProjectListProps) {
    const { hiddenProjects, toggleProjectVisibility, reorderProjects } = useStore();
